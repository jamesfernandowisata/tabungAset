            ...
            <View style={styles.container}>
                <View style={styles.headerContainer}>
                    <View styles={styles.emoteContainer}>
                        <Header emotes={faPlusSquare} colorPick="#00b1d9" wheretogo="home" routeSend={props.navigation} textHeader="Adding Assets"/>
                    </View>
                    <View styles={styles.subNavContainer}>
                        <HeaderDetailNavigation routeSend={props.navigation} colorPick="#00b1d9" currentPosition="1"/>
                    </View>
                </View>
                <View style={styles.bodyContainer}>
                    ...
                    <View style={styles.subsubBodyContainer}>
                        ...
                        <TouchableOpacity onPress={()=>setShowDraft(!showDraft)}>
                            <FontAwesomeIcon icon={showHidden?(faChevronDown):(faChevronUp)} size={20} color="#00b1d9"/>
                        </TouchableOpacity>
                    </View>
                ...
                <TouchableOpacity
                    onPress={() => props.navigation.navigate("addRegis")}
...
export default RegisterAssetsH;